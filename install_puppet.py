#!/usr/bin/env python
# This is to install puppet on a client Mac or Mac VM and bind it to the puppet server defined.
# usage: sudo python install_puppet.py --appendhosts
# or usage: curl -o /tmp/install_puppet.py https://raw.github.com/rnbdomain/macscripts/master/Puppet-Install/install_puppet.py; sudo python /tmp/install_puppet.py --appendhosts
import urllib2
...
parser.add_argument('--server', help='The URL of the Puppet Server. Defaults to puppet.rnbdomain.dev')
parser.add_argument('--certname', help='The certname of the client. Defaults to client.rnbdomain.dev')
...
if args['server']:
    ...
    puppetserver = 'puppet.rnbdomain.dev'
...
if internet_on:
    ...
    if args['appendhosts']:
        with open("/etc/hosts", "a") as myfile:
            myfile.write("192.168.202.10 puppet.rnbdomain.dev  puppet")
